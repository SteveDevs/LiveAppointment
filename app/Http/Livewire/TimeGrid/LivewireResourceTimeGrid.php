...
namespace App\Http\Livewire\TimeGrid;
...
class LivewireResourceTimeGrid extends Component
{
    ...
    public function mount($startingHour = 0,
                          $endingHour = 12,
                          $interval = 15,
                          $gridView = null,
    ...
    public function styles()
    {
        return [
            ...
            'hourAndSlotsContainer' => 'border relative -mt-px bg-theme-color-light bg-opacity-30',

            'hourWrapper' => 'border relative -mt-px bg-white',

            'hour' => 'p-2 text-xs text-theme-color-dark text-opacity-80 flex justify-center items-center',
            ...
            'eventTitle' => 'text-xs font-medium bg-theme-color-dark p-2 text-white',
