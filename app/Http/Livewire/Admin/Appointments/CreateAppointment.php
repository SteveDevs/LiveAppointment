...
class CreateAppointment extends Component
{
    ...
    {
        $appointmentsExist = (new AppointmentRepository())->checkAvailability($this->appointment->start_time, $this->appointment->finish_time, $this->appointment->employee_id, $this->appointment->client_id);
    ...
    {
        $this->appointment = Appointment::make();
