<?php
namespace App\Http\Livewire\DataTables\Http\Livewire;
...
use App\Http\Livewire\DataTables\ColumnSet;
use App\Http\Livewire\DataTables\Exports\DatatableExport;
use App\Http\Livewire\DataTables\Traits\WithCallbacks;
use App\Http\Livewire\DataTables\Traits\WithPresetDateFilters;
use App\Http\Livewire\DataTables\Traits\WithPresetTimeFilters;
...
class LivewireDatatable extends Component
{
    ...
    protected $query;
    protected $listeners = ['refreshLivewireDatatable', 'showDeleteModalCall', 'deleteHandle'];

    public $showNew = true;
    public $newLink = 'dashboard';
    public $tableName;
    ...
    public function delete($id)
    {
        ...
        $this->dispatchBrowserEvent('notify', 'Record deleted successfully!');
    }

    public function showDelete($id){
        $this->showDeleteModal = true;
        $this->deleteId = $id;
        $this->showDeleteModalCall('');
    }
    ...
    public function showDeleteModalCall($args){
            }
    ...
    public function deleteSelected()
    {
        if (count($this->selected) > 0){
            ...
            $this->dispatchBrowserEvent('notify', trans('Records deleted successfully!'));
        }
    }
