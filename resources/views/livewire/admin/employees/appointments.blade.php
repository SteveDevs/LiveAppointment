<div>
  ...
  >
    ...
    <div class="w-full pt-4">
      ...
      <div x-show="openTab === 2"><span class="text-theme-color-dark">{{ __('Today') }}</span>
        <livewire:admin.employees.appointments.employee-appointment-today :modelResource="$this->clients" :modelEvent="$this->appointments_day">
      </div>

      <div x-show="openTab === 1">
        <livewire:admin.employees.appointments.employee-appointment-calendar :userId="$this->employee->id"
